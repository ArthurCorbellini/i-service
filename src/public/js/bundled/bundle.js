...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiYXJ0Y29yYiIsImEiOiJjbGFpd3JpcDQwNm4wM3FzdXF1anh5NXVhIn0.sjf09-lJ0QVIfzWLOmYH1A";
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Bem-vindo de volta!");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)("error", "Erro ao efetuar o Log out! Tente novamente mais tarde.");
          case 10:
          case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            urlApi = "http://127.0.0.1:3000/api/v1/users";
            url = urlApi + (type === "password" ? "/updateMyPassword" : "/me");
            console.log(data);
            _context.next = 6;
            return (0, _axios.default)({
              method: "PATCH",
          ...
          case 6:
            res = _context.sent;
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Cadastro alterado com sucesso!");
            }
            _context.next = 13;
            break;
          case 10:
